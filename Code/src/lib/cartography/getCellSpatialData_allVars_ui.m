function getCellSpatialData_allVars_ui()
    ...
    params = ["Volume", "PrincipalAxisLength", "Solidity", "SurfaceArea", "aspectRatio", "sphericity", "normalizedVolume", "irregularityShapeIndex", "apical_NumNeighs", "apical_Area", "basal_NumNeighs", "basal_Area", "cell_height", "lateral_NumNeighs", "lateral_Area", "apicalPerimeter", "basalPerimeter", "apicalNeighsOfNeighs", "basalNeighsOfNeighs", "lateralNeighsOfNeighs","average_cell_wall_Area", "std_cell_wall_Area", "scutoids", "apicoBasalTransitions", "surfaceRatio","totalApicalArea","totalBasalArea", 'basal3dInfo'];
