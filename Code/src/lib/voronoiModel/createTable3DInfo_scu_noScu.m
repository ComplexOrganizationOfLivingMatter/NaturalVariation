...
for folderIx = 3:numel(dirPathFolders)
    ...
    for subfolderIx = 3:numel(dirPathShape)
        ...
        for xlsfileIx = 1:numel(dirPathXls)
            ...
            auxTableScu = [{fileName}, {currentFolder}, {currentFolderShape}, {mean(currentTableScu.apicalNumNeighs)}, {std(currentTableScu.apicalNumNeighs)}, {mean(currentTableScu.basalNumNeighs)}, {std(currentTableScu.basalNumNeighs)}, {mean(current3DNeighsArrayScu)}, {std(current3DNeighsArrayScu)}, {sum(currentTableScu.scutoid)/size(currentTableScu,1)}, {sum(currentTableScu.apicoBasalTransitions)}, {mean(currentTableScu.apicalCellArea)}, {std(currentTableScu.apicalCellArea)}, {mean(currentTableScu.basalCellArea)}, {std(currentTableScu.basalCellArea)}, {mean(currentTableScu.apicalPerim)}, {std(currentTableScu.apicalPerim)}, {mean(currentTableScu.basalPerim)}, {std(currentTableScu.basalPerim)}, {sum(currentTableScu.apicalNumNeighs==3)/size(currentTableScu,1)}, {sum(currentTableScu.apicalNumNeighs==4)/size(currentTableScu,1)}, {sum(currentTableScu.apicalNumNeighs==5)/size(currentTableScu,1)}, {sum(currentTableScu.apicalNumNeighs==6)/size(currentTableScu,1)},{sum(currentTableScu.apicalNumNeighs==7)/size(currentTableScu,1)}, {sum(currentTableScu.apicalNumNeighs==8)/size(currentTableScu,1)},{sum(currentTableScu.apicalNumNeighs==9)/size(currentTableScu,1)}, {sum(currentTableScu.basalNumNeighs==3)/size(currentTableScu,1)}, {sum(currentTableScu.basalNumNeighs==4)/size(currentTableScu,1)}, {sum(currentTableScu.basalNumNeighs==5)/size(currentTableScu,1)}, {sum(currentTableScu.basalNumNeighs==6)/size(currentTableScu,1)},{sum(currentTableScu.basalNumNeighs==7)/size(currentTableScu,1)}, {sum(currentTableScu.basalNumNeighs==8)/size(currentTableScu,1)},{sum(currentTableScu.basalNumNeighs==9)/size(currentTableScu,1)},  {sum(current3DNeighsArrayScu==3)/size(current3DNeighsArrayScu,1)}, {sum(current3DNeighsArrayScu==4)/size(current3DNeighsArrayScu,1)}, {sum(current3DNeighsArrayScu==5)/size(current3DNeighsArrayScu,1)}, {sum(current3DNeighsArrayScu==6)/size(current3DNeighsArrayScu,1)},{sum(current3DNeighsArrayScu==7)/size(current3DNeighsArrayScu,1)}, {sum(current3DNeighsArrayScu==8)/size(current3DNeighsArrayScu,1)},{sum(current3DNeighsArrayScu==9)/size(current3DNeighsArrayScu,1)}];
            auxTableNoScu = [{fileName}, {currentFolder}, {currentFolderShape}, {mean(currentTableNoScu.apicalNumNeighs)}, {std(currentTableNoScu.apicalNumNeighs)}, {mean(currentTableNoScu.basalNumNeighs)}, {std(currentTableNoScu.basalNumNeighs)}, {mean(current3DNeighsArrayNoScu)}, {std(current3DNeighsArrayNoScu)}, {sum(currentTableNoScu.scutoid)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.apicoBasalTransitions)}, {mean(currentTableNoScu.apicalCellArea)}, {std(currentTableNoScu.apicalCellArea)}, {mean(currentTableNoScu.basalCellArea)}, {std(currentTableNoScu.basalCellArea)}, {mean(currentTableNoScu.apicalPerim)}, {std(currentTableNoScu.apicalPerim)}, {mean(currentTableNoScu.basalPerim)}, {std(currentTableNoScu.basalPerim)}, {sum(currentTableNoScu.apicalNumNeighs==3)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.apicalNumNeighs==4)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.apicalNumNeighs==5)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.apicalNumNeighs==6)/size(currentTableNoScu,1)},{sum(currentTableNoScu.apicalNumNeighs==7)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.apicalNumNeighs==8)/size(currentTableNoScu,1)},{sum(currentTableNoScu.apicalNumNeighs==9)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.basalNumNeighs==3)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.basalNumNeighs==4)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.basalNumNeighs==5)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.basalNumNeighs==6)/size(currentTableNoScu,1)},{sum(currentTableNoScu.basalNumNeighs==7)/size(currentTableNoScu,1)}, {sum(currentTableNoScu.basalNumNeighs==8)/size(currentTableNoScu,1)},{sum(currentTableNoScu.basalNumNeighs==9)/size(currentTableNoScu,1)},  {sum(current3DNeighsArrayNoScu==3)/size(current3DNeighsArrayNoScu,1)}, {sum(current3DNeighsArrayNoScu==4)/size(current3DNeighsArrayNoScu,1)}, {sum(current3DNeighsArrayNoScu==5)/size(current3DNeighsArrayNoScu,1)}, {sum(current3DNeighsArrayNoScu==6)/size(current3DNeighsArrayNoScu,1)},{sum(current3DNeighsArrayNoScu==7)/size(current3DNeighsArrayNoScu,1)}, {sum(current3DNeighsArrayNoScu==8)/size(current3DNeighsArrayNoScu,1)},{sum(current3DNeighsArrayNoScu==9)/size(current3DNeighsArrayNoScu,1)}];
