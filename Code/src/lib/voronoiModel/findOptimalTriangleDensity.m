...
savePath = '/media/pedro/6TB/jesus/NaturalVariation/voronoiModel_6/';
...
for ix100 = 1:10
    ...
    fileName = strcat('voronoiModel_', date, '_principalAxisLength_', num2str(75), '_', num2str(100), '_', num2str(100), '_nSeeds_', num2str(100), '_nDots_', num2str(100), '_lloydIters_', num2str(1), '_runId_', num2str(ix100), '_LAYER_', num2str(0));
...
for ix250 = 1:10
    ...
    fileName = strcat('voronoiModel_', date, '_principalAxisLength_', num2str(75), '_', num2str(100), '_', num2str(100), '_nSeeds_', num2str(100), '_nDots_', num2str(250), '_lloydIters_', num2str(1), '_runId_', num2str(ix250), '_LAYER_', num2str(0));
...
for ix500 = 1:10
    ...
    fileName = strcat('voronoiModel_', date, '_principalAxisLength_', num2str(75), '_', num2str(100), '_', num2str(100), '_nSeeds_', num2str(100), '_nDots_', num2str(500), '_lloydIters_', num2str(1), '_runId_', num2str(ix500), '_LAYER_', num2str(0));
...
for ix750 = 1:10
    ...
    fileName = strcat('voronoiModel_', date, '_principalAxisLength_', num2str(75), '_', num2str(100), '_', num2str(100), '_nSeeds_', num2str(100), '_nDots_', num2str(750), '_lloydIters_', num2str(1), '_runId_', num2str(ix750), '_LAYER_', num2str(0));
...
for ix1000 = 1:10
    ...
    fileName = strcat('voronoiModel_', date, '_principalAxisLength_', num2str(75), '_', num2str(100), '_', num2str(100), '_nSeeds_', num2str(100), '_nDots_', num2str(1000), '_lloydIters_', num2str(1), '_runId_', num2str(ix1000), '_LAYER_', num2str(0));
