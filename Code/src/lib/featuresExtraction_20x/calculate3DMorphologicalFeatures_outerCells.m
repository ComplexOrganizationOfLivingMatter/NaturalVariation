function [allGeneralInfo,allTissues,allLumens,allHollowTissue3dFeatures,allNetworkFeatures,totalMeanCellsFeatures,totalStdCellsFeatures]=calculate3DMorphologicalFeatures_outerCells(labelledImage,apicalLayer,basalLayer,lateralLayer,lumenImage,path2save,fileName,pixelScale,contactThreshold,validCells,noValidCells, dilatedVx)
